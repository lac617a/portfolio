...
export const Tools = () => {
	...
	return (
		<Box as="section" id="tools" className="container">
			...
			<Box
				className="grid"
				mediaMinMd={{gridTemplateColumns: "repeat(3, 1fr)"}}
				marginTop={20}
			>
				<Card
					title="Native Piece"
					...
					stack={["React", "Rollup", "Babel", "NPM", "TypeScript"]}
				/>
				<Card
					title="@profiya/bucket"
					description="Librería ligera y moderna para manejar Cloudflare R2 usando AWS SDK v3."
					src="https://miro.medium.com/v2/resize:fit:640/format:webp/1*cDHe5Q_RDkNt_g-KKxZVcw.png"
					link="https://www.npmjs.com/package/@profiya/bucket"
					stack={["AWS SDK v3", "Cloudflare R2", "TypeScript"]}
				/>
				<Card
				...
				<Card
					...
					stack={["React", "Rollup", "Babel", "NPM", "POO", "TypeScript"]}
				/>
			</Box>
		</Box>
	);
